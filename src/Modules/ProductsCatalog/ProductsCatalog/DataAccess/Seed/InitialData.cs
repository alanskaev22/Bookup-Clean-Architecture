...
public static class InitialData
{
    ...
    public static IEnumerable<Product> Products => [
        Product.Create(
            _tenantId,
            ProductId.Create(Guid.NewGuid().ToString()),
            ...
            Money.Create(125, Currency.Create(CurrencyConstants.USD)),
            [ Category.Create(_tenantId, "Facial Cleansers"),Category.Create(_tenantId, "Skin Care")],
            [ MediaResource.Create(_tenantId, Url.Create("https://example.com/image1.jpg"), MediaResourceType.Image,1, "Image", "png") ]
        ),
        Product.Create(
            _tenantId,
            ProductId.Create(Guid.NewGuid().ToString()),
            ...
            Money.Create(65.59M, Currency.Create(CurrencyConstants.USD)),
            [ Category.Create(_tenantId, "Cosmetics"),Category.Create(_tenantId, "Skin Care")],
            [ MediaResource.Create(_tenantId, Url.Create("https://example.com/image2.jpg"), MediaResourceType.Image,1, "Image", "png") ]
        ),
        ];
}
